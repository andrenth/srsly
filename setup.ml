...
(* OASIS_START *)
(* DO NOT EDIT (digest: aa8fa87bb870be9c21acc7afea1ef076) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "spf_milter_in.ml"; });
               Executable
                 ({
                     cs_name = "spf-milter-out";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "spf_milter_out.ml"; 
                   })
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\214H\231B\150\024)\226\020\156\213\006\160\020\017c";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
