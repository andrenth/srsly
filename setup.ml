...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2bbc111c86ddbd417f9ae2bbaa49a96a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "srsly_in.ml"; });
               Executable
                 ({
                     cs_name = "srsly-out";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "srsly_out.ml"; });
               Executable
                 ({
                     cs_name = "srsly";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "s\171\232\136s\023\172\243W\169\186M\217\204\212l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
