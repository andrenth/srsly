...
(* OASIS_START *)
(* DO NOT EDIT (digest: aa05c7401630229eb111bc0d6827cac9) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "srslyd.ml"; });
               Executable
                 ({
                     cs_name = "srsly-policyd";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "srsly_policyd.ml"; });
               Executable
                 ({
                     cs_name = "srsly-milter-in";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "srsly_milter_in.ml"; 
                   });
               Executable
                 ({
                     cs_name = "srsly-milter-out";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "srsly_milter_out.ml";
                      })
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\199C\192\r8\223\132\140\184{\161\128\152O\204\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
