...
(* OASIS_START *)
(* DO NOT EDIT (digest: bfe90427717b07ccaaf78596246f0346) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "srsly_milter.ml"; });
               Executable
                 ({
                     cs_name = "srsly";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("release", None);
                           FindlibPackage ("release.config", None);
                           FindlibPackage ("release.util", None);
                           FindlibPackage ("spf", None);
                           FindlibPackage ("srs", None);
                           FindlibPackage ("str", None);
                           FindlibPackage ("threads", None);
                   ...
                   {exec_custom = false; exec_main_is = "srsly.ml"; })
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "w5\130\134}\224\173IJ\214\229\174\254$\184\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
